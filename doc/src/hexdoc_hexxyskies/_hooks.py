...
class HexxySkiesPlugin(ModPluginImplWithProps, LoadTaggedUnionsImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str, props: Properties) -> ModPlugin:
        return HexxySkiesModPlugin(branch=branch, props=props)
...
class HexxySkiesModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexxyskies"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexxyskies, "_templates"
